...
keytool -importkeystore -noprompt -destkeystore generated/kafka_server_keystore.jks -srckeystore generated/kafka-server.pkcs12 -srcstoretype pkcs12 -srcstorepass mypassword -deststorepass mypassword -deststoretype JKS -alias 1
