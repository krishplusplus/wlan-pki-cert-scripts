openssl pkcs12 -export -in servercert.pem -inkey serverkey.pem -passout pass:mypassword -out server.pkcs12 -name 1 -CAfile testCA/cacert.pem -caname root -chain
